...
<div class="space-y-6" x-data="{
    ...
    <div>
        ...
        <p class="text-muted-foreground mt-1">Create a new team</p>
    </div>
    ...
    <div class="bg-card border border-border rounded-lg shadow p-6">
        <form method="POST" action="{{ route('admin.teams.store') }}" class="space-y-4" @submit.prevent="createTeam">
            ...
            <div class="flex gap-4">
                ...
                <button type="submit" class="px-4 py-2 bg-gradient-to-r from-primary to-secondary text-primary-foreground rounded-md hover:opacity-95 focus:outline-none focus:ring-2 focus:ring-ring/50 transition-opacity">Create Team</button>
            </div>
        </form>
    </div>
</div>
